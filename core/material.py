...
builtin_materials = ["A35","Aluminum","Alumina","Barium tetratitanate","Beeswax","Beryllia","Brass","Bronze" ,
    ...
    "Nylon","Parafin","Plexiglass","Polyethylene","Polyethylene foam","Polystyrene","Porcelain","Rexolite","Silicon",
...
dielectric_ = {"A35":5.6,"Aluminum":0,"Alumina":9.5,"Barium tetratitanate":37,"Beeswax":2.35,"Beryllia":6.4,"Brass":0,"Bronze":0 ,
    ...
    "Nylon":2.84,"Parafin":2.24,"Plexiglass":2.6,"Polyethylene":2.25,"Polyethylene foam":1.68,"Polystyrene":2.54,"Porcelain":5.04,"Rexolite":2.54,"Silicon":11.9,
...
permeability_ = {"A35":0,"Aluminum":1,"Alumina":0,"Barium tetratitanate":0,"Beeswax":0,"Beryllia":0,"Brass":1,"Bronze":1,
    ...
    "Plexiglass":0,"Polyethylene":0,"Polyethylene foam":0,"Polystyrene":0,"Porcelain":0,"Rexolite":0,"Silicon":0,"Styrofoam":0,"Teflon":0,
...
lossTangent_ = {"A35":0.0041,"Aluminum":0,"Alumina":0.0003,"Barium tetratitanate":0.0005,"Beeswax":0.005,"Beryllia":0.0003,"Brass":0,"Bronze":0,
    ...
    "Nylon":0.012,"Parafin":0.0002,"Plexiglass":0.0057,"Polyethylene":0.0004,"Polyethylene foam":0.0003,"Polystyrene":0.00033,"Porcelain":0.0078,"Rexolite":0.00048,
...
conductivity_ = {"A35":0,"Aluminum":3.186e7,"Alumina":0,"Barium tetratitanate":0,"Beeswax":0,"Beryllia":0,"Brass":2.564e7,"Bronze":1e7,\
    ...
    "Mild steel":1.01e7,"Nylon":0,"Parafin":0,"Plexiglass":0,"Polyethylene":0,"Polyethylene foam":0,"Polystyrene":0,"Porcelain":0,"Rexolite":0,"Silicon":0,
...
class Medium:
    ...
    def __init__(self, **kwargs):
        ...
        if self.rel_dielectric != 0:
            self.epsilon = physical_constants["e0"]*self.rel_dielectric
        else:
            self.epsilon = physical_constants["e0"]
        if self.rel_permeability != 0:
            self.mu = physical_constants["mu0"]*self.rel_permeability
        else:
            self.mu = physical_constants["mu0"]
    ...
    def skin_depth(self,freq):
        ...
        delta_s = np.sqrt(2/(2*np.pi*freq*self.mu*sigma))
        return delta_s
